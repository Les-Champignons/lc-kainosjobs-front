...
describe("JobRoleController", function () {
	...
	describe("getAllJobRolesList", function () {
		it("should render view and return all available job roles", () =>
		...
		it("should render view with error message when error thrown", () =>
			__awaiter(this, void 0, void 0, function* () {
	...
	describe("getDetailedJobRoleController", function () {
		it("should render view and return job information", () =>
			__awaiter(this, void 0, void 0, function* () {
